...
params <- list('pathname' = "C:/Users/Administrator/Documents/Rotation/fruits-360",
  'training_folder'= "Training",
  'test_folder' = "Test",
  'internet_path'= "C:/Users/Administrator/Documents/Rotation/Photos_to_test_model",
  'internet_file_type' = ".jpg",
  'class_names'= folder_names(pathname,training_folder),
  'fruit_list' = c("Apple_Braeburn","Banana","Orange","Grape_White","Kiwi"), # get label numbers after specify name of fruit
  'class_names_frame' = class_names_frame,
  'labels_to_be_tested' = 20:21, #labels_to_be_tested = 1:(length(class_names))

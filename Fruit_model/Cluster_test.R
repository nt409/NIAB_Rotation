...
#parLapply(cl,100:200*2, clustering) # , MoreArgs=data)
#data <-  
# data <-  clusterApply(cl, list_of_labels_to_be_tested[-1], cluster_data, MoreArgs = data,label,Fruit_frame,pathname_of_images,folder)
